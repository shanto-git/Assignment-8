      ...
      <div className="p-20 bg-base-200 min-h-screen ">
        <div className="grid grid-cols-12 lg:flex-row gap-10">
          ...
          <div className="grid col-span-9">
            ...
            <p className="pt-3">
             Developed by <span className="text-blue-700 font-semibold">{appDetails.companyName}</span>
            </p>
            ...
            <div className="flex justify-start items-center gap-20">
                <div className="">
                    ...
                    <h1 className="text-4xl font-bold mb-4">{appDetails.downloads}</h1>
                </div>
                <div className="">
                    <img src={icon2} alt="" />
                    <p className="text-gray-600 text-sm mb-4">Average Ratings</p>
                    <h1 className="text-4xl font-bold mb-4">{appDetails.ratingAvg}</h1>
                </div>
                <div className="">
                    <img src={icon3} alt="" />
                    <p className="text-gray-600 text-sm mb-4">Total Reviews</p>
                    <h1 className="text-4xl font-bold mb-4">{appDetails.reviews}</h1>
                </div>
            </div>
            <button className="btn btn-success text-white font-bold w-52 h-10">Install Now ({appDetails.size} MB)</button>
          </div>
        </div>
      <div className="divider divider-start py-7"></div>
